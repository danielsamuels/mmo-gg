...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Level', fields ['level']
        db.create_unique('characters_level', ['level'])

        # Adding field 'Character.user'
        db.add_column('characters_character', 'user',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=0, to=orm['auth.User'], unique=True),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'Level', fields ['level']
        db.delete_unique('characters_level', ['level'])

        # Deleting field 'Character.user'
        db.delete_column('characters_character', 'user_id')
